...
const demoData = [
    { title: 'Financial Clarity', question: 'How can I improve my financial situation?', interpretation: 'Cards highlighted budgeting, patience, and avoiding impulsive spending.', created_at: '2024-01-10 10:15:00' },
    { title: 'Career Guidance', question: 'What should I focus on to advance my career?', interpretation: 'The reading emphasized learning new skills and building relationships.', created_at: '2024-02-12 14:30:00' },
    { title: 'Relationship Insight', question: 'How can I strengthen my relationship?', interpretation: 'Cards suggested open communication and mutual understanding.', created_at: '2024-03-08 09:20:00' },
    { title: 'Love Reading', question: 'What should I know about my love life right now?', interpretation: 'The spread pointed to new opportunities for connection.', created_at: '2024-04-18 18:05:00' },
    { title: 'Decision Making', question: 'Should I take the new opportunity?', interpretation: 'Cards advised balancing intuition with practical considerations.', created_at: '2024-05-06 11:45:00' },
    { title: 'Monthly Outlook', question: 'What energy surrounds me this month?', interpretation: 'Themes of growth, patience, and reflection appeared.', created_at: '2024-06-21 16:10:00' },
    { title: 'Personal Growth', question: 'How can I become a better version of myself?', interpretation: 'The reading encouraged self-confidence and consistency.', created_at: '2024-07-14 08:55:00' },
    { title: 'Friendship Guidance', question: 'How can I improve a friendship?', interpretation: 'Cards emphasized honesty and quality time.', created_at: '2024-08-09 19:25:00' },
    { title: 'Workplace Challenges', question: 'How should I handle current work stress?', interpretation: 'The spread suggested setting boundaries and staying focused.', created_at: '2024-09-03 12:40:00' },
    { title: 'Family Matters', question: 'What should I focus on within my family?', interpretation: 'Cards highlighted compassion and understanding.', created_at: '2024-10-17 15:00:00' },
    { title: 'Future Path', question: 'What direction is my life heading?', interpretation: 'The reading suggested gradual progress toward long-term goals.', created_at: '2024-11-11 10:30:00' },
    { title: 'Creative Inspiration', question: 'How can I unlock more creativity?', interpretation: 'Cards encouraged experimentation and curiosity.', created_at: '2024-12-05 17:15:00' },
    { title: 'Confidence Boost', question: 'How can I build my confidence?', interpretation: 'The spread pointed toward recognizing past successes.', created_at: '2025-01-09 09:10:00' },
    { title: 'Spiritual Journey', question: 'What should I focus on spiritually?', interpretation: 'Cards suggested mindfulness and self-reflection.', created_at: '2025-02-14 13:35:00' },
    { title: 'Life Balance', question: 'How can I create better balance?', interpretation: 'The reading highlighted the need for rest and prioritization.', created_at: '2025-03-22 08:20:00' },
    { title: 'New Beginning', question: 'What should I know about this new chapter?', interpretation: 'Cards indicated optimism and fresh opportunities.', created_at: '2025-04-16 14:50:00' },
    { title: 'Self-Care Reading', question: 'How can I take better care of myself?', interpretation: 'The spread encouraged healthy routines and boundaries.', created_at: '2025-05-07 11:05:00' },
    { title: 'Goal Achievement', question: 'What will help me reach my goals?', interpretation: 'Cards emphasized persistence and planning.', created_at: '2025-06-18 16:25:00' },
    { title: 'Communication Advice', question: 'How can I communicate more effectively?', interpretation: 'The reading suggested clarity and active listening.', created_at: '2025-07-10 09:45:00' },
    { title: 'Inner Wisdom', question: 'What is my intuition trying to tell me?', interpretation: 'Cards encouraged trusting inner guidance.', created_at: '2025-08-23 18:10:00' },
    { title: 'Career Change', question: 'Is it time for a career change?', interpretation: 'The spread suggested exploring possibilities while staying practical.', created_at: '2025-09-12 12:30:00' },
    { title: 'Financial Opportunity', question: 'What opportunities are available financially?', interpretation: 'Cards pointed toward steady growth rather than quick rewards.', created_at: '2025-10-05 10:05:00' },
    { title: 'Healing Reading', question: 'What do I need to heal from?', interpretation: 'The reading emphasized acceptance and patience.', created_at: '2025-11-19 15:40:00' },
    { title: 'Travel Plans', question: 'What should I know about upcoming travel?', interpretation: 'Cards suggested flexibility and openness to surprises.', created_at: '2025-12-08 09:15:00' },
    { title: 'Learning Journey', question: 'How can I learn more effectively?', interpretation: 'The spread highlighted consistency and curiosity.', created_at: '2026-01-14 13:00:00' },
    { title: 'Leadership Reading', question: 'How can I become a better leader?', interpretation: 'Cards emphasized empathy and confidence.', created_at: '2026-02-09 17:20:00' },
    { title: 'Romantic Potential', question: 'What potential exists in my romantic life?', interpretation: 'The reading suggested meaningful new connections.', created_at: '2026-03-18 11:10:00' },
    { title: 'Stress Management', question: 'How can I reduce stress?', interpretation: 'Cards pointed toward simplicity and self-care.', created_at: '2026-04-06 08:35:00' },
    { title: 'Long-Term Vision', question: 'What should I focus on for the future?', interpretation: 'The spread emphasized patience and strategic thinking.', created_at: '2026-05-21 16:55:00' },
    { title: 'Career Confidence', question: 'How can I feel more confident at work?', interpretation: 'Cards highlighted preparation and trusting your abilities.', created_at: '2026-06-12 10:20:00' }
];
...
const readingCards = [
    ...
    { reading_id: 27, card_id: 17, position_number: 4, position_name: "Warning", is_reversed: false },
    { reading_id: 27, card_id: 22, position_number: 4, position_name: "Outcome", is_reversed: false },
...
db.serialize(() => {
    for (const reading of demoData) {
        const sql = `INSERT INTO readings (title, question, interpretation, created_at) VALUES (?, ?, ?, ?)`;
        db.run(sql, [reading.title, reading.question, reading.interpretation, reading.created_at]);
    }
